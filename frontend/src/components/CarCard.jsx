...
const CarCard = ({
  ...
  const imageUrl =
    car.image ||
    "https://res.cloudinary.com/dhyqgl7ie/image/upload/v1/car_images/default-car.png";
  ...
  const totalPrice =
    rentalPeriod && car.pricePerDay * (parseInt(rentalPeriod) || 1);
      ...
      <Box sx={{ position: "relative" }}>
        <CardMedia
          ...
          onError={(e) => {
            ...
            e.target.src =
              "https://res.cloudinary.com/your-cloud-name/image/upload/v1/car_images/default-car.png";
          }}
        />{" "}
        {car.discount > 0 && (
          <Chip
