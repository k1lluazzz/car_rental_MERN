    ...
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      ...
      <Box
        sx={{
          ...
          "&::before": {
            ...
            bottom: 0,
            backgroundImage:
              "url(https://res.cloudinary.com/dfo1vdnhk/image/upload/v1747730571/background_image_y4hnzh.jpg)",
      ...
      >
        ...
        >
          ...
          >
            Trải nghiệm lái xe an toàn và tiện lợi với dịch vụ cho thuê xe tự
            lái của chúng tôi
          </Typography>
          <Typography
            variant="h3"
